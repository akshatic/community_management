...
<?php
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $descri = $_POST["descri"];
            if($item!=NULL){
                $sql = " INSERT INTO laf (item, place,descri) VALUES ('$item', '$place','$descri')";
                mysqli_query($conn,$sql);
                header("location:laf.php");
            }else{
                echo "Tech error";
            }
            $use =  mysqli_insert_id($conn);
           $_SESSION["use"] = $use;
           
        }      
        $result = mysqli_query($conn, "SELECT * FROM laf");     
?>
<!doctype html>
<html lang="en">
<head>
...
<body id="body-pd">  
        ...
        <nav class="nav">
            <div> <a href="dashboard.php" class="nav_logo"> <svg xmlns="http://www.w3.org/2000/svg" class="nav_logo-icon" width="16" height="16" fill="currentColor" class="bi bi-stack" viewBox="0 0 16 16">
                ...
                <div class="nav_list">
                    ...
                    <a href="bill.php" class="nav_link active"> <svg xmlns="http://www.w3.org/2000/svg" class="nav_icon" width="16" height="16" fill="currentColor" class="bi bi-currency-dollar" viewBox="0 0 16 16">
    ...
    <div class="container-fluid">
      <div class="row"  style="padding-top:2vh">
        <div class="col-lg-6">
            <h2>Did you find something? <br>Please Enter the details below</h2>
            <form method="POST" action="laf.php" >
  	        <div>
  	            <input type="text" name="item" placeholder="What is it?">
                <input type="text" name="place" placeholder="Where was it found?">
                <textarea id="text" cols="40" rows="4" name="descri" placeholder="Say something about the item..."></textarea>
        ...
        <div class="col-lg-6">
            <?php
                while ($row = mysqli_fetch_array($result)){
                    echo "<div class='row' id='there'>";
                    echo  "<p>". "Someone Lost there ". $row['item']." at ".$row['place']. "<p>";
                    echo  "<p>". "They describe it as - ". $row['descri']." ."."<p>";
                    echo "</div>";
                }
            ?>
        </div>
