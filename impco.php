            ...
            <div> <a href="dashboard.php" class="nav_logo"> <svg xmlns="http://www.w3.org/2000/svg" class="nav_logo-icon" width="16" height="16" fill="currentColor" class="bi bi-stack" viewBox="0 0 16 16">
                ...
                <div class="nav_list">
                    ...
                    <a href="time.php" class="nav_link "> <svg xmlns="http://www.w3.org/2000/svg" class="nav_icon" width="16" height="16" fill="currentColor" class="bi bi-clock-fill" viewBox="0 0 16 16">
                     ...
                     <a href="impco.php" class="nav_link active"> <svg xmlns="http://www.w3.org/2000/svg" class="nav_icon" width="16" height="16" fill="currentColor" class="bi bi-person-rolodex" viewBox="0 0 16 16">
    ...
    <div class="container-fluid" style="padding-top: 3%">
      <div class="row">
        ...
        <div class="col-lg-6" >
          ...
          <h4>Emergency:-</h4>
          <ul>
              <li>Fire &#128658;- 95XX312XX4</li>
              <li>Police &#128659;- 95XX312XX4</li>
              <li>Ambulance &#128657;- 95XX312XX4</li>
              <li>Women Safety &#x1F469;- 95XX312XX4</li>
              <li>Snake Catcher &#128013;- 95XX312XX4</li>
              <li>Disaster Helpline &#127786;- 95XX312XX4</li>
              <li>Security Guard &#128737;- 95XX312XX4</li>
              <li>Covid Helpline &#x1F9A0;- 95XX312XX4</li>
          </ul>
        </div>
        <div class="col-lg-6">
          <h4>Service Providers</h4>
          <ul>
            <li>Internet Issues &#127760;- 95XX312XX4</li>
            <li>Water Suppply Issues &#128688;- 95XX312XX4</li>
            <li>Electricity Issues &#x26A1;- 95XX312XX4</li>
            <li>Road Issue &#x1F6E3;- 95XX312XX4</li>
            <li>Drainage Issues &#x1F573;- 95XX312XX4</li>
            <li>Car cleaning &#128663;- 95XX312XX4</li>
            <li>Bathroom Cleaning &#x1F6BD;- 95XX312XX4</li>
            <li>Maid &#129529;- 95XX312XX4</li>
          </ul>
        </div>
      </div>
    </div>
