...
<body id="body-pd">  
    <header class="header" id="header">
        ...
        <div class="header_img"> <img src="back.jpg" alt=""> </div>
    </header>
        ...
        <nav class="nav">
            <div> <a href="dashboard.php" class="nav_logo"> <svg xmlns="http://www.w3.org/2000/svg" class="nav_logo-icon" width="16" height="16" fill="currentColor" class="bi bi-stack" viewBox="0 0 16 16">
                ...
                <div class="nav_list">
                    ...
                    <a href="time.php" class="nav_link active"> <svg xmlns="http://www.w3.org/2000/svg" class="nav_icon" width="16" height="16" fill="currentColor" class="bi bi-clock-fill" viewBox="0 0 16 16">
    ...
    <div class="container-fluid" style="padding-top: 3%">
      <div class="row">
        <div class="col-lg-12">
          ...
          <ul>
              <li>Gym &#127947; - 6AM to 11AM And 4PM to 9PM  <span> <button id="oneo"  class="ocbtn open">OPEN NOW &#128512;</button> <button id="onec" class="ocbtn close">CLOSED NOW &#128577;</button> </span></li>
              <li>Swimming pool &#127946; - 7AM to 10AM And 4PM to 7PM  <span><button id="twoo" class="ocbtn open">OPEN NOW &#128512;</button> <button id="twoc" class="ocbtn close">CLOSED NOW &#128577;</button> </span></li>
              <li>ClubHouse &#127968; - 6AM to 9PM  <span><button id="thro" class="ocbtn open">OPEN NOW &#128512;</button> <button id="thrc" class="ocbtn close">CLOSED NOW &#128577;</button> </span></li>
              <li>Badminton court &#127992; - 6AM to 10AM And 4PM to 9PM  <span><button id="foo" class="ocbtn open">OPEN NOW &#128512;</button> <button id="foc"class="ocbtn close">CLOSED NOW &#128577;</button> </span></li>
              <li>Childrens Park &#127904; - 6AM to 10AM And 4PM to 8PM  <span><button  id="fio"class="ocbtn open">OPEN NOW &#128512;</button> <button id="fic" class="ocbtn close">CLOSED NOW &#128577;</button> </span></li>
              <li>Indoor games room &#127918;- 7AM to 11AM And 4PM to 9PM  <span><button  id="sio"class="ocbtn open">OPEN NOW &#128512;</button> <button id="sic" class="ocbtn close">CLOSED NOW &#128577;</button> </span</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <script>
      const d = new Date();
      let hour = d.getHours();
          if((hour>=6 && hour<11) ||(hour>=16 && hour<21) ){
            var elem = document.getElementById('onec');
            elem.parentNode.removeChild(elem);
          }else{
            var elem1 = document.getElementById('oneo');
            elem1.parentNode.removeChild(elem1);
          }
          
          if((hour>=7 && hour<10) ||(hour>=16 && hour<19) ){
            var elem = document.getElementById('twoc');
            elem.parentNode.removeChild(elem);
          }else{
            var elem1 = document.getElementById('twoo');
            elem1.parentNode.removeChild(elem1);
          }
          
          if(hour>=6 && hour<21){
            var elem = document.getElementById('thrc');
            elem.parentNode.removeChild(elem);
          }else{
            var elem1 = document.getElementById('thro');
            elem1.parentNode.removeChild(elem1);
          }
          ...
          if((hour>=6 && hour<10) ||(hour>=16 && hour<20) ){
            var elem = document.getElementById('fic');
            elem.parentNode.removeChild(elem);
          }else{
            var elem1 = document.getElementById('fio');
            elem1.parentNode.removeChild(elem1);
          }

          if((hour>=7 && hour<11) ||(hour>=16 && hour<21) ){
            var elem = document.getElementById('sic');
            elem.parentNode.removeChild(elem);
          }else{
            var elem1 = document.getElementById('sio');
            elem1.parentNode.removeChild(elem1);
          }
