<?php
    ...
    $u=$_SESSION["userid"];
    $sql1 = "SELECT name,unq_no, rent,elec,water FROM users WHERE id= $u";
...
<body id="body-pd">  
    ...
    <div class="container-fluid">
      <div class="row"  style="padding-top:10vh">
            <h1>Hello <?php Echo $naam ?>, From House Number <?php Echo $ghar ?>.  </h1>
            <div class="col-lg-12" id="easy" >
            <ul>
              <li>Rent+Maintenance for this month is: <?php Echo $bhada ?>.</li>
              <li>Water bill for this month is: <?php Echo $pani ?>.</li>
              <li>Electricity bill for this month is: <?php Echo $light ?>.</li>
            </ul>
          </div>
      </div>
    </div>
